...
def get_today_data():
    ...
    engine_center = create_engine('mysql+mysqlconnector://root:root@192.168.59.185:3306/jinqiao_meikuang')
    ...
    # model_path = os.path.join(project_root, 'data711_2024.xlsx')
    ...
    n.insert(loc=0, column='姓名', value= employee_name1)
    n.insert(loc=0, column='检测日期', value=employee_time1)
    columns_names = ['检测日期','姓名','工号','安全帽佩戴情况_-7', '矿灯佩戴情况_7', '毛巾佩戴情况_7', '胶鞋佩戴情况_7', '自救器佩戴情况_7',
    ...
    n_not = pd.DataFrame()
    n_not.insert(loc=0, column='工号', value=employee_ids3)
    n_not.insert(loc=0, column='姓名', value=employee_name3)
    n_not.insert(loc=0, column='检测日期', value=employee_time2)
    columns_name2 = ['检测日期', '姓名', '工号']
