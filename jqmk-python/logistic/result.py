...
class StatusCodeEnum(Enum):
    ...
    NECESSARY_PARAM_ERR = (4001, '缺少员工id或日期')
    # 111请求中缺少了必须的参数，例如未提供员工姓名或日期。

    DATA_INSUFFICIENT = (4002, '7次行为数据记录不足')
    ...
    MISSING_KEY_PARAMETER = (4007, '缺少关键参数')
    # 111缺少必要的参数，例如未提供模型训练方法的关键参数。

    INVALID_KEY_VALUE = (4008, '关键参数值无效')
    # 111关键参数值无效，例如训练模型关键参数yes。
